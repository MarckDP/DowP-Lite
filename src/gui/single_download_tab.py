...
class SingleDownloadTab(ctk.CTkFrame):
    ...
    def _create_widgets(self):
        ...
        self.save_thumbnail_button.grid(row=0, column=0, columnspan=2, padx=0, sticky="ew")
    ...
    def _open_release_page(self):
        ...
        if self.release_page_url:
            ...
            self.app_status_label.configure(text=f"DowP Lite v{self.APP_VERSION} - Verificando de nuevo...")
    ...
    def _render_setup_progress(self):
        ...
        if active_count > 0:
            ...
            if deno_state["text"]: final_text = deno_state["text"]; final_progress = deno_state["value"]
