...
def apply_icon(window):
    """Aplica el icono según el SO para evitar TclError en macOS."""
    def _set():
        try:
            ...
            if sistema == "Windows":
                ...
                # En macOS no se usa iconbitmap para ventanas individuales.
                # El icono se define en el bundle .icns al compilar.
                pass
        except Exception as e:
            print(f"DEBUG: No se pudo aplicar el icono: {e}")
        
    # Necesitamos importar platform si no está en este archivo
    import platform
